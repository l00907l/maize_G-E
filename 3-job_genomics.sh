...
python src/create_individuals.py

# filter VCF and create kinships matrices (you will need `vcftools` and `plink` here):
vcftools --vcf D:/yan/竞赛/农业比赛/Maize_GxE/maize/data/Training_Data/5_Genotype_Data_All_Years.vcf --keep 'output/individuals.csv' --recode --recode-INFO-all --out output/maize_indiv
